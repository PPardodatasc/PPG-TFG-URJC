...
DIV=9   			        % =calc --> calculate optimal page layout;
...
% From R. Bringhurst: prop. 1:1.618 (approx. 1:\phi) --> 82-86 chars./line w/ Tex Gyre Pagella font
% Add ~33 pts head + 42 pts \footskip
%\areaset[current]{\textwidth}{1.76\textwidth}
\areaset[current]{0.925\textwidth}{1.85\textwidth}
...
% v.4 copyright page
% Se debe sustituir la imagen de la licencia CC por la que se haya seleccionado
% al publicar el TFG
\newpage
~\vfill
...
\par\noindent \textcopyright~2026 Nombre y apellidos . Algunos derechos reservados.
\medskip

\par\noindent El código fuente de este Trabajo Fin de Grado está disponible en:\\ 
    {\url{enlace github aqui}
    \medskip
    
    \par\noindent  Este trabajo se entrega bajo la licencia Creative Commons\\
    \texttt{Reconocimiento-CompartirIgual (by-sa)}. Para obtener\\
    la licencia completa, véase:\\
    \url{https://creativecommons.org/licenses/by-sa/4.0/deed.es}.
    \bigskip
    
    \par\noindent \textit{Primera impresión, \today}
\thispagestyle{empty}
...
\vspace{1cm}
\large
\textbf{Autor :} Pablo Pardo Gutiérrez  \\
...
\qquad\qquad\qquad\qquad \newline de 2026, siendo calificada por el siguiente tribunal:
...
\vspace{0.8cm}
\begin{flushright}
Móstoles/Fuenlabrada, a \qquad$\;\,$ de \qquad\qquad\qquad\qquad de 2026
\end{flushright}
